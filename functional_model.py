...
model_name = '2lstm + tdist + 3 dense + 2dropout' #'two layer lstm + 3 dense'
model_save_file = 'models/best_{}_{}_lb_{}_spl_{}_pt_{}_{}.h5'.format(model_name, data_set[:-4], look_back, split, patience, now)
tensorboard = TensorBoard(log_dir='logs/{}_{}_lb_{}_spl_{}_pt_{}_{}'.format(model_name, data_set[:-4], look_back, split, patience, now)
...
flat = Flatten()(time_dist)
dense_1 = Dense(128, name='dense_layer_1')(flat)
drop_1 = Dropout(0.2)(dense_1)
dense_2 = Dense(64, name='dense_layer_2')(drop_1)
drop_2 = Dropout(0.2)(dense_2)
dense_3 = Dense(32, name='dense_layer_3')(drop_2)
